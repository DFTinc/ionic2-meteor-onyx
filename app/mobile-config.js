App.info({
    id: 'com.dft.meteor.ionic2.onyx',
    name: 'Ionic2-Meteor-Onyx',
    description: 'An Ionic2 Meteor application demonstrating the Onyx Cordova Plugin',
    author: 'Matthew Wheatley',
    email: 'mwheatley@diamondfortress.com',
    version: '0.0.1'
});
...
// Deployment server DNS
App.accessRule('http://ionic2-meteor-onyx.duckdns.org:3000/*');